...
Функционал: Редактирование профиля игры
  ...
  Сценарий: Автор игры успешно редактирует её данные
    ...
    И ввожу "2030-01-01 00:00" в поле "Начало игры"
    ...
    И должен увидеть "2030-01-01 00:00"
  ...
  Сценарий: После начала игры нельзя редактировать профиль игры
    Допустим Iv назначает начало игры "Котлованы Бишкека" на "2099-01-01 00:00"
    Если сейчас "2099-01-01 00:01"
